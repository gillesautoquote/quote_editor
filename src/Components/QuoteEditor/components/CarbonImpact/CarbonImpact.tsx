...
export const CarbonImpact: React.FC<CarbonImpactProps> = ({
  ...
  return (
    <div className="tw-mb-6 tw-flex tw-justify-center">
      <div className="tw-flex tw-flex-col tw-items-center tw-gap-3 tw-bg-gradient-to-br tw-from-green-50 tw-to-emerald-50 tw-border-2 tw-border-green-200 tw-rounded-xl tw-px-6 tw-py-4 tw-shadow-sm">
        <h3 className="tw-text-sm tw-font-semibold tw-text-green-800 tw-flex tw-items-center tw-gap-2">
        ...
        <div className="tw-flex tw-items-center tw-gap-4">
          <div className="tw-flex tw-items-center tw-gap-3 tw-bg-white tw-rounded-lg tw-px-4 tw-py-3 tw-border tw-border-green-200">
            <Bus className="tw-w-7 tw-h-7 tw-text-green-600" strokeWidth={2} />
            <div className="tw-flex tw-flex-col">
              <span className="tw-text-2xl tw-font-bold tw-text-green-700 tw-leading-none">
          ...
          <div className="tw-text-xl tw-font-bold tw-text-green-600">=</div>

          <div className="tw-flex tw-items-center tw-gap-3 tw-bg-white tw-rounded-lg tw-px-4 tw-py-3 tw-border tw-border-green-200">
            <Cloud className="tw-w-7 tw-h-7 tw-text-green-600" strokeWidth={2} />
            <div className="tw-flex tw-flex-col">
              <span className="tw-text-2xl tw-font-bold tw-text-green-700 tw-leading-none">
        ...
        {carbonImpact.description && (
          <div className="tw-mt-3 tw-pt-3 tw-border-t tw-border-green-200 tw-w-full tw-flex tw-justify-center">
