...
export const CarbonImpact: React.FC<CarbonImpactProps> = ({
  ...
  return (
    <div className="tw-mb-6 tw-flex tw-justify-center">
      <div className="tw-flex tw-flex-col tw-items-center tw-gap-3 tw-bg-primary-light tw-border-2 tw-border-primary tw-rounded-xl tw-px-6 tw-py-4 tw-shadow-sm">
        <h3 className="tw-text-sm tw-font-semibold tw-text-primary tw-flex tw-items-center tw-gap-2">
        ...
        <div className="tw-flex tw-items-center tw-gap-4">
          <div className="tw-flex tw-items-center tw-gap-3 tw-bg-white tw-rounded-lg tw-px-4 tw-py-3 tw-border tw-border-primary">
            <Bus className="tw-w-7 tw-h-7 tw-text-primary" strokeWidth={2} />
            <div className="tw-flex tw-flex-col">
              <span className="tw-text-2xl tw-font-bold tw-text-primary tw-leading-none">
          ...
          <div className="tw-text-xl tw-font-bold tw-text-primary">=</div>

          <div className="tw-flex tw-items-center tw-gap-3 tw-bg-white tw-rounded-lg tw-px-4 tw-py-3 tw-border tw-border-primary">
            <Cloud className="tw-w-7 tw-h-7 tw-text-primary" strokeWidth={2} />
            <div className="tw-flex tw-flex-col">
              <span className="tw-text-2xl tw-font-bold tw-text-primary tw-leading-none">
        ...
        {carbonImpact.description && (
          <div className="tw-mt-3 tw-pt-3 tw-border-t tw-border-primary tw-w-full tw-flex tw-justify-center">
