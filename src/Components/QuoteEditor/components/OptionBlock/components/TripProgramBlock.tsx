      ...
      <div className={`tw-mb-3 tw-flex tw-flex-wrap tw-gap-2 tw-items-center ${printMode ? 'tw-hidden' : ''} print:tw-hidden`}>
        ...
        {STEP_FILTERS.map(filter => (
          <button
            ...
            disabled={readonly}
            className="tw-inline-flex tw-items-center tw-px-[0.35rem] tw-py-[0.15rem] tw-text-[0.68rem] tw-font-medium qe-rounded-full qe-border tw-transition-all tw-whitespace-nowrap"
            style={{
